...
import com.github.MathCunha16.controllers.docs.FileControllerDocs;
import com.github.MathCunha16.data.dto.UploadFileResponseDTO;
import com.github.MathCunha16.services.FileStorageService;
...
public class FileController implements FileControllerDocs {
    ...
    public List<UploadFileResponseDTO> uploadMultiPartFiles(@RequestParam("files") MultipartFile[] files) {
        ...
        return Arrays.asList(files)
                .stream().map(file -> uploadFile(file)).toList();
    }
